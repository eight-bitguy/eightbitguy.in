...
const LinkedInIcon = () => {
    const onClick = () => {
        window.open('http://www.linkedIn.com/in/eightbitguy');
    };
    return(
        <svg id="linkedIn" fill="#ff7f02"  viewBox="-3 -3 32 32" width="45px" height="45px" onClick={onClick} className='hover-cursor'>
